...
cur.execute(add_type, [video_data.video_type.get('id'), video_data.video_type.get('name')])
print('添加类别完成')
...
#视频信息列表
add_info_list = video_data.video_info_list() + [video_data.author.get('mid'), video_data.video_type.get('id')]
print(add_info_list)
